...
curl POST -H "username: Richard" -H "password: 3TQI8TB39DFIMI6" "http://127.0.0.1:8080"
curl -Method POST -Uri http://127.0.0.1:8080 -ContentType 'application/json' -Body '{"username": "Richard", "password":"3TQI8TB39DFIMI6"}' -UseBasicParsing